...
namespace MyFirstWinFormsProject
{
    public partial class frmMain : Form
    {
        ...
        {
            Form notifylcon = new Notifylcon();
            notifylcon.ShowDialog();
        }

        private void button13_Click(object sender, EventArgs e)
        {
            Form Imagelist = new Image_List();
            Imagelist.ShowDialog();
        }

        private void button14_Click(object sender, EventArgs e)
        {
            Form ProgressBar = new Form2();
            ProgressBar.ShowDialog();
        }

        private void button15_Click(object sender, EventArgs e)
        {
            Form listview = new listview();
            listview.ShowDialog();
        }

        private void button16_Click(object sender, EventArgs e)
        {
            Form ErorrProvider = new ErorrProvider();
            ErorrProvider.ShowDialog();
        }

        private void button17_Click(object sender, EventArgs e)
        {

            Form Trackbar = new Trackbar();
            Trackbar.ShowDialog();
        }

        private void button18_Click(object sender, EventArgs e)
        {
            Form tabcontrol = new tabcontrol();
            tabcontrol.ShowDialog();
        }

        private void button19_Click(object sender, EventArgs e)
        {
            Form Dialogs = new Dialogs();
            Dialogs.ShowDialog();
        }
    }
}
